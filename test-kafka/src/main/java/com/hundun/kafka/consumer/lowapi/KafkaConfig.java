...
/**
 * @DESC entity for kafka configures
 * @author xinshiyou
 */
public class KafkaConfig {
	...
	public String toString() {
		return "[brokers:" + replicaBrokers.toString() + "] [port:" + port + "] [topic:" + topic + "] [partition num:"
				+ partitionNum + "] [patch size:" + patchSize + "] [start point:" + subscribeStartPoint + "]";
	}
}