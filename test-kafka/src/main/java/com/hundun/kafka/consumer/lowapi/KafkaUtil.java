...
public class KafkaUtil {
	...
	/**
	 * @DESC 找一个broker leader
	 * @param seedBrokers配置的broker列表
	 * @param portbroker端口
	 * @param topic
	 * @param partition
	 * @return
	 ...
	 * @throws Exception
	 */
	public static String findNewLeader(String oldLeader, List<String> seedBrokers, int port, String topic,
	 ...
	 * @return
	 */
	public static long getSpecificOffset(SimpleConsumer consumer, String topic, int partition, long whichTime,
			String clientId) {
